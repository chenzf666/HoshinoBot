...
base_path = os.path.abspath(os.path.join(hoshino.config.RES_DIR, "record"))
...
'''
# =========================#
hiyori_folder = os.path.join(base_path, "100111猫拳/")
...
# =========================#
yui_folder = os.path.join(base_path, "100211优衣/")
...
# =========================#
rei_folder = os.path.join(base_path, "100311剑圣/")
...
# =========================#
misogi_folder = os.path.join(base_path, "100411炸弹/")
...
# =========================#
matsuri_folder = os.path.join(base_path, "100511跳跳虎/")
...
# =========================#
akari_folder = os.path.join(base_path, "100611妹法/")
...
# =========================#
miyako_folder = os.path.join(base_path, "100711布丁/")
...
# =========================#
yuki_folder = os.path.join(base_path, "100811镜子/")
...
# =========================#
anna_folder = os.path.join(base_path, "100911中二/")
...
# =========================#
maho_folder = os.path.join(base_path, "101011狐狸/")
...
# =========================#
rino_folder = os.path.join(base_path, "101111妹弓/")
...
# =========================#
hatsune_folder = os.path.join(base_path, "101211初音/")
...
# =========================#
nanaka_folder = os.path.join(base_path, "101311七七香/")
...
# =========================#
kasumi_folder = os.path.join(base_path, "101411侦探/")
...
# =========================#
misato_folder = os.path.join(base_path, "101511圣母/")
...
# =========================#
suzuna_folder = os.path.join(base_path, "101611暴击弓/")
...
# =========================#
kaori_folder = os.path.join(base_path, "101711狗拳/")
...
# =========================#
mimi_folder = os.path.join(base_path, "102011兔子/")
...
# =========================#
kurumi_folder = os.path.join(base_path, "102111铃铛/")
...
# =========================#
yori_folder = os.path.join(base_path, "102211姐法/")
...
# =========================#
ayane_folder = os.path.join(base_path, "102311熊锤/")
...
# =========================#
suzume_folder = os.path.join(base_path, "102511女仆/")
...
# =========================#
rin_folder = os.path.join(base_path, "102611松鼠/")
...
# =========================#
eriko_folder = os.path.join(base_path, "102711病娇/")
...
# =========================#
saren_folder = os.path.join(base_path, "102811充电宝/")
...
# =========================#
nozomi_folder = os.path.join(base_path, "102911偶像/")
...
# =========================#
ninon_folder = os.path.join(base_path, "103011扇子/")
...
# =========================#
shinobu_folder = os.path.join(base_path, "103111忍/")
...
# =========================#
akino_folder = os.path.join(base_path, "103211哈哈剑/")
...
# =========================#
mahiru_folder = os.path.join(base_path, "103311奶牛/")
...
# =========================#
yukari_folder = os.path.join(base_path, "103411黄骑/")


@sv.on_fullmatch((
        "优花梨语音", "ユカリ语音", "Yukari语音", "由加莉语音", "酒鬼语音", "奶骑语音", "圣骑语音", "🍺语音", "🍺👻语音", "yukari语音", "黄骑语音", "由嘉莉语音",
        "由加利语音"
), only_to_me=False)
async def record_send(bot, ev):
...
# =========================#
kyouka_folder = os.path.join(base_path, "103611小仓唯/")


@sv.on_fullmatch((
        "镜华语音", "キョウカ语音", "Kyouka语音", "xcw语音", "小苍唯语音", "8岁语音", "八岁语音", "喷水萝语音", "八岁喷水萝语音", "8岁喷水萝语音", "XCW语音",
        "kyouka语音", "小仓唯语音"
), only_to_me=False)
async def record_send(bot, ev):
...
# =========================#
tomo_folder = os.path.join(base_path, "103711卜毛/")
...
# =========================#
shiori_folder = os.path.join(base_path, "103811tp弓/")
...
# =========================#
aoi_folder = os.path.join(base_path, "104011香菜弓/")
...
# =========================#
chika_folder = os.path.join(base_path, "104211绿毛/")
...
# =========================#
makoto_folder = os.path.join(base_path, "104311狼/")
...
# =========================#
iriya_folder = os.path.join(base_path, "104411伊利亚/")
...
# =========================#
kuuka_folder = os.path.join(base_path, "104511抖m/")
...
# =========================#
tamaki_folder = os.path.join(base_path, "104611猫剑/")
...
# =========================#
jun_folder = os.path.join(base_path, "104711黑骑/")
...
# =========================#
mifuyu_folder = os.path.join(base_path, "104811子龙/")
...
# =========================#
shizuru_folder = os.path.join(base_path, "104911姐姐/")
...
# =========================#
misaki_folder = os.path.join(base_path, "105011大眼/")
...
# =========================#
mitsuki_folder = os.path.join(base_path, "105111深月/")
...
# =========================#
rima_folder = os.path.join(base_path, "105211羊驼/")
...
# =========================#
monika_folder = os.path.join(base_path, "105311毛二力/")
...
# =========================#
tsumugi_folder = os.path.join(base_path, "105411裁缝/")
...
# =========================#
ayumi_folder = os.path.join(base_path, "105511路人/")
...
# =========================#
ruka_folder = os.path.join(base_path, "105611流夏/")
...
# =========================#
jiita_folder = os.path.join(base_path, "105711吉他/")
...
# =========================#
pecoriinu_folder = os.path.join(base_path, "105811佩可/")


@sv.on_fullmatch((
        "贪吃佩可语音", "ペコリーヌ语音", "Pecoriinu语音", "佩可莉姆语音", "吃货语音", "公主语音", "饭团语音", "🍙语音", "佩可语音", "pecoriinu语音",
        "尤丝蒂亚娜·F·阿斯特莱亚语音", "Eustiana von Astraea语音", "ユースティアナ・フォン・アストライア语音", "尤丝蒂亚娜语音", "eustiana语音", "Eustiana语音"
), only_to_me=False)
async def record_send(bot, ev):
...
# =========================#
kokkoro_folder = os.path.join(base_path, "105911妈/")
...
# =========================#
muimi_folder = os.path.join(base_path, "106111无意义/")
...
# =========================#
arisa_folder = os.path.join(base_path, "106311亚里沙/")


@sv.on_fullmatch((
        "亚里莎语音", "アリサ语音", "Arisa语音", "鸭梨瞎语音", "瞎子语音", "鸭梨傻语音", "亚丽莎语音", "亚莉莎语音", "瞎子弓语音", "🍐🦐语音", "亚里沙语音", "arisa语音",
        "yls语音", "YLS语音"
), only_to_me=False)
async def record_send(bot, ev):
...
# =========================#
kaya_folder = os.path.join(base_path, "106511嘉夜/")
...
# =========================#
neneka_folder = os.path.join(base_path, "107011nnk/")


@sv.on_fullmatch((
        "似似花语音", "ネネカ语音", "Neneka语音", "变貌大妃语音", "448语音", "捏捏卡语音", "变貌语音", "大妃语音", "nnk语音", "neneka语音", "NNK语音",
        "永远地神语音", "永远滴神语音", "永远嘀神语音"
), only_to_me=False)
async def record_send(bot, ev):
...
# =========================#
christina_folder = os.path.join(base_path, "107111克总/")


@sv.on_fullmatch((
        "克莉丝提娜语音", "クリスティーナ语音", "Kurisutiina语音", "Christina语音", "Cristina语音", "誓约女君语音", "女帝语音", "克语音", "克总语音",
        "kurisutiina语音", "christina语音", "cristina语音", "誓约女帝语音", "克里斯提娜语音", "克里斯汀娜语音"
), only_to_me=False)
async def record_send(bot, ev):
...
# =========================#
shuichi_folder = os.path.join(base_path, "107511水吃/")


@sv.on_fullmatch((
        "贪吃佩可(夏日)语音", "ペコリーヌ(サマー)语音", "Pekoriinu(Summer)语音", "水饭语音", "水吃货语音", "水佩可语音", "水公主语音", "水饭团语音", "水🍙语音",
        "泳吃语音", "泳饭语音", "泳吃货语音", "泳佩可语音", "泳公主语音", "泳饭团语音", "泳🍙语音", "泳装吃货语音", "泳装公主语音", "泳装饭团语音", "泳装🍙语音", "佩可(夏日)语音",
        "🥡语音", "👙🍙语音", "泼妇语音", "水吃语音", "pekoriinu(summer)语音"
), only_to_me=False)
async def record_send(bot, ev):
...
# =========================#
shuima_folder = os.path.join(base_path, "107611水妈/")


@sv.on_fullmatch((
        "可可萝(夏日)语音", "コッコロ(サマー)语音", "Kokkoro(Summer)语音", "水白语音", "水可语音", "水可可语音", "水可可萝语音", "水可可罗语音", "泳装可可萝语音",
        "泳装可可罗语音", "水妈语音", "氵妈语音", "氵白语音"
), only_to_me=False)
async def record_send(bot, ev):
...
# =========================#
shuinvpu_folder = os.path.join(base_path, "107711水女仆/")
...
# =========================#
shuihei_folder = os.path.join(base_path, "107811水黑/")


@sv.on_fullmatch((
        "凯留(夏日)语音", "キャル(サマー)语音", "Kyaru(Summer)语音", "水黑语音", "水黑猫语音", "水臭鼬语音", "泳装黑猫语音", "泳装臭鼬语音", "潶语音", "溴语音",
        "💧黑语音", "氵黑语音", "氵黑猫语音", "法狼语音"
), only_to_me=False)
async def record_send(bot, ev):
...
# =========================#
shuimaojian_folder = os.path.join(base_path, "107911水猫剑/")
...
# =========================#
shuizilong_folder = os.path.join(base_path, "108011水子龙/")
...
# =========================#
wanshengren_folder = os.path.join(base_path, "108111万圣忍/")
...
# =========================#
wanshengdayan_folder = os.path.join(base_path, "108311万圣大眼/")


@sv.on_fullmatch((
        "美咲(万圣节)语音", "ミサキ(ハロウィン)语音", "Misaki(Halloween)语音", "万圣美咲语音", "瓜眼语音", "🎃眼语音", "🎃👀语音", "🎃👁️语音", "🎃👁语音",
        "万圣大眼语音"
), only_to_me=False)
async def record_send(bot, ev):
...
# =========================#
wanshengbuding_folder = os.path.join(base_path, "108211万圣布丁/")


@sv.on_fullmatch((
        "宫子(万圣节)语音", "ミヤコ(ハロウィン)语音", "Miyako(Halloween)语音", "万圣宫子语音", "狼丁语音", "狼布丁语音", "万圣🍮语音", "🐺🍮语音", "🎃🍮语音",
        "👻🍮语音", "万圣布丁语音"
), only_to_me=False)
async def record_send(bot, ev):
...
# =========================#
shengdanqiange_folder = os.path.join(base_path, "108411圣诞千歌/")
...
# =========================#
shengdanlingdang_folder = os.path.join(base_path, "108511圣诞铃铛/")
...
# =========================#
shengdanxiongchui_folder = os.path.join(base_path, "108611圣诞熊锤/")
...
# =========================#
xinchunmaoquan_folder = os.path.join(base_path, "108711新春猫拳/")
...
# =========================#
chuntian_folder = os.path.join(base_path, "108811春田/")
...
# =========================#
xinchunjiansheng_folder = os.path.join(base_path, "108911新春剑圣/")
...
# =========================#
lianbing_folder = os.path.join(base_path, "109011情人节病娇/")
...
# =========================#
qingrenjiejiejie_folder = os.path.join(base_path, "109111情人节姐姐/")
...
# =========================#
an_folder = os.path.join(base_path, "109211安/")
...
# =========================#
ruu_folder = os.path.join(base_path, "109311眼球/")
...
# =========================#
gurea_folder = os.path.join(base_path, "109411龙姬/")
...
# =========================#
jianghushanzi_folder = os.path.join(base_path, "109611江户扇子/")
...
# =========================#
jianghum_folder = os.path.join(base_path, "109511江户抖m/")
...
# =========================#
remu_folder = os.path.join(base_path, "109711蕾姆/")
...
# =========================#
ramu_folder = os.path.join(base_path, "109811拉姆/")
...
# =========================#
emiria_folder = os.path.join(base_path, "109911艾米莉亚/")
...
# =========================#
shuibao_folder = os.path.join(base_path, "110011水暴/")


@sv.on_fullmatch((
        "铃奈(夏日)语音", "スズナ(サマー)语音", "Suzuna(Summer)语音", "瀑击弓语音", "水爆语音", "水爆弓语音", "瀑语音", "水暴弓语音", "瀑弓语音", "泳装暴弓语音",
        "泳装爆弓语音", "水暴语音", "氵爆语音", "氵暴语音", "氵政委语音", "水政委语音"
), only_to_me=False)
async def record_send(bot, ev):
...
# =========================#
shuilaoshi_folder = os.path.join(base_path, "110111水老师/")
...
# =========================#
shuidianzhan_folder = os.path.join(base_path, "110311水电站/")


@sv.on_fullmatch((
        "咲恋(夏日)语音", "サレン(サマー)语音", "Saren(Summer)语音", "水电语音", "泳装充电宝语音", "泳装咲恋语音", "水着咲恋语音", "水电宝语音", "水充语音", "👙🔋语音",
        "水电站语音", "充电的神语音", "充电滴神语音", "充电地神语音", "充电嘀神语音"
), only_to_me=False)
async def record_send(bot, ev):
...
# =========================#
shuilang_folder = os.path.join(base_path, "110411水狼/")


@sv.on_fullmatch((
        "真琴(夏日)语音", "マコト(サマー)语音", "Makoto(Summer)语音", "浪语音", "水🐺语音", "泳狼语音", "泳月语音", "泳月月语音", "泳朋语音", "水月语音", "水月月语音",
        "水朋语音", "👙🐺语音", "水狼语音", "氵狼语音"
), only_to_me=False)
async def record_send(bot, ev):
...
# =========================#
shuigou_folder = os.path.join(base_path, "110511水狗/")
...
# =========================#
shuihuli_folder = os.path.join(base_path, "110611水狐狸/")


@sv.on_fullmatch((
        "真步(夏日)语音", "マホ(サマー)语音", "Maho(Summer)语音", "水壶语音", "水真步语音", "水maho语音", "氵🦊语音", "水🦊语音", "💧🦊语音", "氵狐狸语音",
        "水狐狸语音", "水真布语音", "氵真布语音", "氵狐语音", "水狐语音"
), only_to_me=False)
async def record_send(bot, ev):
...
# =========================#
jkxiangcai_folder = os.path.join(base_path, "110711jk香菜/")
...
# =========================#
kuroe_folder = os.path.join(base_path, "110811华哥/")
...
# =========================#
chieru_folder = os.path.join(base_path, "110911切噜/")
...
# =========================#
yuni_folder = os.path.join(base_path, "111011优妮/")
...
# =========================#
maocangwei_folder = os.path.join(base_path, "111111猫仓唯/")


@sv.on_fullmatch((
        "镜华(万圣节)语音", "キョウカ(ハロウィン)语音", "Kyouka(Halloween)语音", "万圣镜华语音", "万圣小仓唯语音", "万圣xcw语音", "黑猫仓唯语音", "mcw语音", "猫唯语音",
        "猫仓语音", "喵唯语音", "猫仓唯语音", "MCW语音", "猫苍唯语音"
), only_to_me=False)
async def record_send(bot, ev):
...
# =========================#
wanshengzhadan_folder = os.path.join(base_path, "111211万圣炸弹/")


@sv.on_fullmatch((
        "禊(万圣节)语音", "ミソギ(ハロウィン)语音", "Misogi(Halloween)语音", "万圣禊语音", "万圣炸弹人语音", "瓜炸弹人语音", "万圣炸语音", "瓜炸语音", "南瓜炸语音",
        "🎃💣语音", "万圣炸弹语音"
), only_to_me=False)
async def record_send(bot, ev):
...
# =========================#
wanshengtuzi_folder = os.path.join(base_path, "111311万圣兔子/")


@sv.on_fullmatch((
        "美美(万圣节)语音", "ミミ(ハロウィン)语音", "Mimi(Halloween)", "万圣兔语音", "万圣兔兔语音", "绷带兔语音", "绷带兔子语音", "万圣美美语音", "绷带美美语音",
        "万圣🐰语音", "绷带🐰语音", "🎃🐰语音", "万圣🐇语音", "绷带🐇语音", "🎃🐇语音", "万圣兔子语音"
), only_to_me=False)
async def record_send(bot, ev):
...
# =========================#
runa_folder = os.path.join(base_path, "111411露娜/")
...
# =========================#
shengdanke_folder = os.path.join(base_path, "111511圣诞克总/")


@sv.on_fullmatch((
        "克莉丝提娜(圣诞节)语音", "クリスティーナ(クリスマス)语音", "Kurisutiina(Xmas)语音", "Christina(Xmas)语音", "Cristina(Xmas)语音", "圣诞克语音",
        "圣诞女帝语音", "蛋克语音", "圣克语音", "必胜客语音", "圣诞克总语音"
), only_to_me=False)
async def record_send(bot, ev):
...
# =========================#
shengdanouxiang_folder = os.path.join(base_path, "111611圣诞偶像/")
...
# =========================#
shengdanyly_folder = os.path.join(base_path, "111711圣诞伊利亚/")


@sv.on_fullmatch((
        "伊莉亚(圣诞节)语音", "イリヤ(クリスマス)语音", "Iriya(Xmas)语音", "圣诞伊莉亚语音", "圣诞伊莉雅语音", "圣诞伊利雅语音", "圣诞yly语音", "圣诞吸血鬼语音", "圣伊语音",
        "圣yly语音", "圣诞伊利亚语音", "圣诞YLY语音"
), only_to_me=False)
async def record_send(bot, ev):
...
# =========================#
chunma_folder = os.path.join(base_path, "111911春妈/")
...
# =========================#
chunhei_folder = os.path.join(base_path, "112011春黑/")


@sv.on_fullmatch((
        "凯留(新年)语音", "キャル(ニューイヤー)语音", "Kyaru(NewYear)语音", "春凯留语音", "春黑猫语音", "春臭鼬语音", "新年凯留语音", "新年黑猫语音", "新年臭鼬语音",
        "唯一神语音", "春黑语音"
), only_to_me=False)
async def record_send(bot, ev):
...
# =========================#
chunnvpu_folder = os.path.join(base_path, "112111春女仆/")
...
# =========================#
shaojiuxian_folder = os.path.join(base_path, "112211魔法少女霞/")


@sv.on_fullmatch((
        "霞(魔法少女)语音", "カスミ(マジカル)语音", "Kasumi(MagiGirl)语音", "魔法侦探语音", "魔法杜宾犬语音", "魔法驴语音", "魔法驴子语音", "魔驴语音", "魔法霞语音",
        "魔法少驴语音", "魔法少女霞语音", "马猴烧酒霞语音"
), only_to_me=False)
async def record_send(bot, ev):
...
# =========================#
shaojiukan_folder = os.path.join(base_path, "112311魔法少女栞/")


@sv.on_fullmatch((
        "栞(魔法少女)语音", "シオリ(マジカル)语音", "Shiori(MagiGirl)语音", "魔法tp弓语音", "魔法TP弓语音", "魔法小栞语音", "魔法白虎弓语音", "魔法白虎妹语音",
        "魔法白虎语音", "魔法少女栞语音", "马猴烧酒栞语音"
), only_to_me=False)
async def record_send(bot, ev):
...
# =========================#
youqibingniu_folder = os.path.join(base_path, "112811游骑兵奶牛/")


@sv.on_fullmatch((
        "真阳(游骑兵)语音", "マヒル(レンジャー)语音", "Mahiru(Ranger)语音", "骑兵奶牛语音", "游侠奶牛语音", "护林员奶牛语音", "护林奶牛语音", "游侠🐄语音", "游侠🐮语音",
        "游骑兵奶牛语音"
), only_to_me=False)
async def record_send(bot, ev):
...
# =========================#
shuanggong_folder = os.path.join(base_path, "112911爽弓/")


@sv.on_fullmatch((
        "璃乃(奇境)语音", "リノ(ワンダー)语音", "Rino(Wonder)语音", "璃乃(仙境)语音", "爱丽丝弓语音", "爱弓语音", "兔弓语音", "奇境妹弓语音", "仙境妹弓语音", "白丝妹弓语音",
        "爽弓语音"
), only_to_me=False)
async def record_send(bot, ev):
...
# =========================#
ailisiluren_folder = os.path.join(base_path, "113011爱丽丝路人/")
...
# =========================#
gaoda_folder = os.path.join(base_path, "180411高达吃货/")


@sv.on_fullmatch((
        "贪吃佩可(公主)语音", "ペコリーヌ(プリンセス)语音", "Pekoriinu(Princess)语音", "公主吃语音", "公主饭语音", "公主吃货语音", "公主佩可语音", "公主饭团语音",
        "公主🍙语音", "命运高达语音", "高达语音", "命运公主语音", "高达公主语音", "春哥高达语音", "🤖🍙语音", "🤖语音", "高达吃货语音"
), only_to_me=False)
async def record_send(bot, ev):
...
# =========================#
diema_folder = os.path.join(base_path, "180511蝶妈/")


@sv.on_fullmatch((
        "可可萝(公主)语音", "コッコロ（プリンセス）语音", "Kokkoro(Princess)语音", "公主妈语音", "月光妈语音", "蝴蝶妈语音", "月光蝶妈语音", "公主可语音", "公主可萝语音",
        "公主可可萝语音", "月光可语音", "月光可萝语音", "月光可可萝语音", "蝶可语音", "蝶可萝语音", "蝶可可萝语音", "蝶妈语音"
), only_to_me=False)
async def record_send(bot, ev):
